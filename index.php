...
//Die if the connection was not successfull
if(!$conn){
...
//check the data inserted  on not
if($result){
  $insert = true;
}    
}
...
<!-- ################################################################################################################### -->
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <a class="navbar-brand" href="#"><img src="http://localhost/CRUD/crudlogo.jpg" height="30px" alt=""></a>
      ...
      <div class="container my-4">
        <form action="/CRUD/index.php" method="POST">
            ...
            <div class="form-group">
                <label for="desc">Note Description</label>
                <textarea class="form-control" id="desccrption" name="description" rows="3"></textarea>
            </div>          
...
if($num > 0){
  $sno = 0;
    while($row = mysqli_fetch_assoc($result)){
      ...
      <td><button class='btn btn-primary edit' id=".$row['sno'].">Edit</button></td> 
      <td><button class='btn btn-primary delete' id=d".$row['sno'].">Delete</button></td>
      </tr>";
